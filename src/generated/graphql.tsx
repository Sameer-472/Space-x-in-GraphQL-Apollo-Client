...
export type DragonsQueryVariables = Exact<{ [key: string]: never; }>;


export type DragonsQuery = { __typename?: 'Query', dragons?: Array<{ __typename?: 'Dragon', name?: string | null | undefined, description?: string | null | undefined, dry_mass_kg?: number | null | undefined, dry_mass_lb?: number | null | undefined, first_flight?: string | null | undefined, crew_capacity?: number | null | undefined, diameter?: { __typename?: 'Distance', feet?: number | null | undefined, meters?: number | null | undefined } | null | undefined } | null | undefined> | null | undefined };

export type LaunchesQueryVariables = Exact<{ [key: string]: never; }>;


export type LaunchesQuery = { __typename?: 'Query', launches?: Array<{ __typename?: 'Launch', details?: string | null | undefined, id?: string | null | undefined, launch_success?: boolean | null | undefined, launch_year?: string | null | undefined, mission_name?: string | null | undefined, links?: { __typename?: 'LaunchLinks', article_link?: string | null | undefined, flickr_images?: Array<string | null | undefined> | null | undefined } | null | undefined, rocket?: { __typename?: 'LaunchRocket', rocket_name?: string | null | undefined } | null | undefined } | null | undefined> | null | undefined };

export type MissionQueryVariables = Exact<{ [key: string]: never; }>;


export type MissionQuery = { __typename?: 'Query', missions?: Array<{ __typename?: 'Mission', manufacturers?: Array<string | null | undefined> | null | undefined, name?: string | null | undefined, description?: string | null | undefined, website?: string | null | undefined, twitter?: string | null | undefined } | null | undefined> | null | undefined };
 ...
 * __useDragonsQuery__
 *
 * To run a query within a React component, call `useDragonsQuery` and pass it any options that fit your needs.
 * When your component renders, `useDragonsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useDragonsQuery({
 *   variables: {
 *   },
 * });
 */
export function useDragonsQuery(baseOptions?: Apollo.QueryHookOptions<DragonsQuery, DragonsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<DragonsQuery, DragonsQueryVariables>(DragonsDocument, options);
      }
export function useDragonsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<DragonsQuery, DragonsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<DragonsQuery, DragonsQueryVariables>(DragonsDocument, options);
        }
export type DragonsQueryHookResult = ReturnType<typeof useDragonsQuery>;
export type DragonsLazyQueryHookResult = ReturnType<typeof useDragonsLazyQuery>;
export type DragonsQueryResult = Apollo.QueryResult<DragonsQuery, DragonsQueryVariables>;
